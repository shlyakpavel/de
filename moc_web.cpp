...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_web_t, stringdata) + ofs \
...
const QMetaObject web::staticMetaObject = {
    { &QWebView::staticMetaObject, qt_meta_stringdata_web.data,
      qt_meta_data_web,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_web.stringdata))
